...
function Test() {
  ...
  const handleAddOption = () => {
    const updatedOptions = [...foptions, { label: "", value: "" }];
    setOptions(updatedOptions);
  };
  ...
  const submit = () => {
    ...
    if (inputType === 'firstname') {
      addFormData({ "input": "text", "props": { "name": "firstName", "value": "" } });
      ...
      addFormData({ "input": inputType, "props": { "name": inputValue, "options": foptions } });
  ...
  const renderInputField = () => {
    switch (inputType) {
      case 'firstname':
        return (
          <div>
            <label htmlFor="input-text">First Name:</label>
            <input
              type="text"
              id="input-text"
              value={inputValue}
      ...
      case 'lastname':
        return (
          <div>
            <label htmlFor="input-text">Last Name:</label>
            <input
              type="text"
              id="input-text"
              value={inputValue}
      ...
      case 'number':
        return (
          <div>
            <label htmlFor="input-text">Contact:</label>
            <input
              type="number"
              id="number"
              value={inputValue}
